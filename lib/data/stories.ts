...
export const STORIES: Story[] = [
  ...
  {
    id: "shikhin-puzhichirathil-vasu",
    name: "Shikhin Puzhichirathil Vasu",
    photo: "/images/students/Shikhin Puzhichirathil Vasu.webp",
    uni: "UWE Bristol",
    course: "MSc Biomedical Science",
    country: "United Kingdom",
    flag: "GB",
    year: "2025",
    quote: "AimBritz guided me to the perfect programme for my biomedical career aspirations.",
    journey: "AimBritz helped me secure admission to UWE Bristol for MSc Biomedical Science. Their expert counsellors understood exactly what I was looking for and guided me through every step of the application process with professionalism and care.",
    before: "Aspiring biomedical scientist",
    after: "UWE Bristol",
  },
  {
    id: "aswani-s",
    name: "Aswani S",
    photo: "/images/students/Aswani S.jpeg",
    uni: "University of Leicester",
    course: "International Business MSc",
    country: "United Kingdom",
    flag: "GB",
    year: "2025",
    quote: "The AimBritz team made my dream of studying at Leicester a reality.",
    journey: "With the dedicated support of the AimBritz team, I was successfully admitted to the University of Leicester for International Business MSc. Their in-depth knowledge of UK universities and thorough application support made all the difference.",
    before: "Exploring international business programmes",
    after: "University of Leicester",
  },
  {
    id: "victor-ebenezer",
    name: "Victor Ebenezer",
    photo: "/images/students/Victor Ebenezer.webp",
    uni: "GISMA University",
    course: "Study Abroad",
    country: "Germany",
    flag: "DE",
    year: "2025",
    quote: "AimBritz opened doors to Germany I never thought possible.",
    journey: "AimBritz guided me through the entire process of securing admission to GISMA University in Germany. Their expertise in European university admissions and end-to-end support made my transition to studying abroad smooth and stress-free.",
    before: "Exploring study options in Europe",
    after: "GISMA University, Germany",
  },
];
